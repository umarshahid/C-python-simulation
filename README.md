...
- **Python Integration**: 
   - The Game interacts with Python to control the behavior of aircraft via an external Python script 
...
- **SDL**: 
   - SDL (Simple DirectMedia Layer) is used for rendering the Game's graphics and handling window events
...
Here is a short video of the Game's render screen:
...
| **pybind11**   | Used for binding C++ and Python, allowing interaction between the Game and the Python script.                                                          | Install it via `pip install pybind11` or include it in your C++ project.                               |
